...
$(function() {
    ...
    //         } else {
    //             var msg = msg_receive('user send');
    //             msg += msg_sent('admin send!');
    //             var html = "<div class='user-chat' id='user-chat" + id + "' data-user-id='" + id + "'>";
    //             html += "<div class='chat-head'><span class='name'>" + name + "</span><span class='opts'><i class='material-icons closeit' data-user-id='" + id + "'>clear</i><i class='material-icons mini-chat' data-user-id='" + id + "'>remove</i></span></div>";
