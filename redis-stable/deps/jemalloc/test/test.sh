...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/taquang2410/workspace/pet_paradise/redis-stable/deps/jemalloc/ /home/taquang2410/workspace/pet_paradise/redis-stable/deps/jemalloc/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/taquang2410/workspace/pet_paradise/redis-stable/deps/jemalloc/ /home/taquang2410/workspace/pet_paradise/redis-stable/deps/jemalloc/
